...
// See jpeg_top_trunc1_7.h for the primary calling header
...
void sub___024root___eval_act(sub___024root* vlSelf) {
    ...
    jpeg_top_trunc1_7__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
...
VL_INLINE_OPT void sub___024root___nba_sequent__TOP__1(sub___024root* vlSelf) {
    ...
    if (vlSelf->rst) {
        ...
        if (vlSelf->enable) {
            vlSelf->jpeg_top__DOT__u19__DOT__u14__DOT__u4__DOT__Y_temp 
                = (0x7fU | (0x3fff80U & ((((vlSelf->jpeg_top__DOT__u19__DOT__u14__DOT__u4__DOT__Y1_product 
                                            >> 7U) 
