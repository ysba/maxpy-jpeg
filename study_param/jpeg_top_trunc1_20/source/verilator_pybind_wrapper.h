...
//---------------------------------------------------------------------------------------------------------------------
// "MAxPy_Vjpeg_top_trunc1_20" class

#pragma GCC visibility push(hidden)
class MAxPy_jpeg_top_trunc1_20 : public jpeg_top_trunc1_20 {
	public:
		MAxPy_jpeg_top_trunc1_20(const char* name);
		~MAxPy_jpeg_top_trunc1_20();
		void eval();
