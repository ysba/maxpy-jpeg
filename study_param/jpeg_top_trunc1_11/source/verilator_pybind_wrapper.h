...
//---------------------------------------------------------------------------------------------------------------------
// "MAxPy_Vjpeg_top_trunc1_11" class

#pragma GCC visibility push(hidden)
class MAxPy_jpeg_top_trunc1_11 : public jpeg_top_trunc1_11 {
	public:
		MAxPy_jpeg_top_trunc1_11(const char* name);
		~MAxPy_jpeg_top_trunc1_11();
		void eval();
