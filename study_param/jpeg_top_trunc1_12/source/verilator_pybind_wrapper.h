...
//---------------------------------------------------------------------------------------------------------------------
// "MAxPy_Vjpeg_top_trunc1_12" class

#pragma GCC visibility push(hidden)
class MAxPy_jpeg_top_trunc1_12 : public jpeg_top_trunc1_12 {
	public:
		MAxPy_jpeg_top_trunc1_12(const char* name);
		~MAxPy_jpeg_top_trunc1_12();
		void eval();
