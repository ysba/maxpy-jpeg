...
//---------------------------------------------------------------------------------------------------------------------
// "MAxPy_Vjpeg_top_copyA_13" class

#pragma GCC visibility push(hidden)
class MAxPy_jpeg_top_copyA_13 : public jpeg_top_copyA_13 {
	public:
		MAxPy_jpeg_top_copyA_13(const char* name);
		~MAxPy_jpeg_top_copyA_13();
		void eval();
