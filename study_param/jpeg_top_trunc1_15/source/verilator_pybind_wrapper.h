...
//---------------------------------------------------------------------------------------------------------------------
// "MAxPy_Vjpeg_top_trunc1_15" class

#pragma GCC visibility push(hidden)
class MAxPy_jpeg_top_trunc1_15 : public jpeg_top_trunc1_15 {
	public:
		MAxPy_jpeg_top_trunc1_15(const char* name);
		~MAxPy_jpeg_top_trunc1_15();
		void eval();
