...
// See jpeg_top_copyB_13.h for the primary calling header

#include "verilated.h"

#include "jpeg_top_copyB_13__Syms.h"
...
VL_ATTR_COLD void sub___024root___eval_triggers__stl(sub___024root* vlSelf) {
    ...
    jpeg_top_copyB_13__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
