...
//---------------------------------------------------------------------------------------------------------------------
// "MAxPy_Vjpeg_top_eta1_9" class

#pragma GCC visibility push(hidden)
class MAxPy_jpeg_top_eta1_9 : public jpeg_top_eta1_9 {
	public:
		MAxPy_jpeg_top_eta1_9(const char* name);
		~MAxPy_jpeg_top_eta1_9();
		void eval();
