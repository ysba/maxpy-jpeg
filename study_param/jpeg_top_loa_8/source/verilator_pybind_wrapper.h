...
//---------------------------------------------------------------------------------------------------------------------
// "MAxPy_Vjpeg_top_loa_8" class

#pragma GCC visibility push(hidden)
class MAxPy_jpeg_top_loa_8 : public jpeg_top_loa_8 {
	public:
		MAxPy_jpeg_top_loa_8(const char* name);
		~MAxPy_jpeg_top_loa_8();
		void eval();
