...
//---------------------------------------------------------------------------------------------------------------------
// "MAxPy_Vjpeg_top_trunc1_18" class

#pragma GCC visibility push(hidden)
class MAxPy_jpeg_top_trunc1_18 : public jpeg_top_trunc1_18 {
	public:
		MAxPy_jpeg_top_trunc1_18(const char* name);
		~MAxPy_jpeg_top_trunc1_18();
		void eval();
