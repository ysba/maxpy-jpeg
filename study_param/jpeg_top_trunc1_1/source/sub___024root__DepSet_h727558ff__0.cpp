...
// See jpeg_top_trunc1_1.h for the primary calling header
...
void sub___024root___eval_act(sub___024root* vlSelf) {
    ...
    jpeg_top_trunc1_1__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
...
VL_INLINE_OPT void sub___024root___nba_sequent__TOP__1(sub___024root* vlSelf) {
    ...
    if (vlSelf->rst) {
        ...
        if (vlSelf->enable) {
            vlSelf->jpeg_top__DOT__u19__DOT__u14__DOT__u4__DOT__Y_temp 
                = (1U | (0x3ffffeU & ((((vlSelf->jpeg_top__DOT__u19__DOT__u14__DOT__u4__DOT__Y1_product 
