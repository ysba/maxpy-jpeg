...
//---------------------------------------------------------------------------------------------------------------------
// "MAxPy_Vjpeg_top_eta1_1" class

#pragma GCC visibility push(hidden)
class MAxPy_jpeg_top_eta1_1 : public jpeg_top_eta1_1 {
	public:
		MAxPy_jpeg_top_eta1_1(const char* name);
		~MAxPy_jpeg_top_eta1_1();
		void eval();
