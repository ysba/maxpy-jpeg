...
//---------------------------------------------------------------------------------------------------------------------
// "MAxPy_Vjpeg_top_trunc1_13" class

#pragma GCC visibility push(hidden)
class MAxPy_jpeg_top_trunc1_13 : public jpeg_top_trunc1_13 {
	public:
		MAxPy_jpeg_top_trunc1_13(const char* name);
		~MAxPy_jpeg_top_trunc1_13();
		void eval();
