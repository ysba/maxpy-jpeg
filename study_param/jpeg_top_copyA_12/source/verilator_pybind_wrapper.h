...
//---------------------------------------------------------------------------------------------------------------------
// "MAxPy_Vjpeg_top_copyA_12" class

#pragma GCC visibility push(hidden)
class MAxPy_jpeg_top_copyA_12 : public jpeg_top_copyA_12 {
	public:
		MAxPy_jpeg_top_copyA_12(const char* name);
		~MAxPy_jpeg_top_copyA_12();
		void eval();
