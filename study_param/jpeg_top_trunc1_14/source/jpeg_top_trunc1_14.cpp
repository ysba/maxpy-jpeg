...
#include "jpeg_top_trunc1_14.h"
#include "jpeg_top_trunc1_14__Syms.h"

//============================================================
// Constructors

jpeg_top_trunc1_14::jpeg_top_trunc1_14(VerilatedContext* _vcontextp__, const char* _vcname__)
    : VerilatedModel{*_vcontextp__}
    , vlSymsp{new jpeg_top_trunc1_14__Syms(contextp(), _vcname__, this)}
    , clk{vlSymsp->TOP.clk}
    , rst{vlSymsp->TOP.rst}
...
jpeg_top_trunc1_14::jpeg_top_trunc1_14(const char* _vcname__)
    : jpeg_top_trunc1_14(Verilated::threadContextp(), _vcname__)
{
}
...
jpeg_top_trunc1_14::~jpeg_top_trunc1_14() {
    delete vlSymsp;
}
...
void jpeg_top_trunc1_14::eval_step() {
    VL_DEBUG_IF(VL_DBG_MSGF("+++++TOP Evaluate jpeg_top_trunc1_14::eval_step\n"); );
#ifdef VL_DEBUG
    // Debug assertions
...
//============================================================
// Events and timing
bool jpeg_top_trunc1_14::eventsPending() { return false; }

uint64_t jpeg_top_trunc1_14::nextTimeSlot() {
...
const char* jpeg_top_trunc1_14::name() const {
    return vlSymsp->name();
}
...
VL_ATTR_COLD void jpeg_top_trunc1_14::final() {
...
const char* jpeg_top_trunc1_14::hierName() const { return vlSymsp->name(); }
const char* jpeg_top_trunc1_14::modelName() const { return "jpeg_top_trunc1_14"; }
unsigned jpeg_top_trunc1_14::threads() const { return 1; }
