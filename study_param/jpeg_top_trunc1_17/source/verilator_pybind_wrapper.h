...
//---------------------------------------------------------------------------------------------------------------------
// "MAxPy_Vjpeg_top_trunc1_17" class

#pragma GCC visibility push(hidden)
class MAxPy_jpeg_top_trunc1_17 : public jpeg_top_trunc1_17 {
	public:
		MAxPy_jpeg_top_trunc1_17(const char* name);
		~MAxPy_jpeg_top_trunc1_17();
		void eval();
