...
//---------------------------------------------------------------------------------------------------------------------
// "MAxPy_Vjpeg_top_trunc1_19" class

#pragma GCC visibility push(hidden)
class MAxPy_jpeg_top_trunc1_19 : public jpeg_top_trunc1_19 {
	public:
		MAxPy_jpeg_top_trunc1_19(const char* name);
		~MAxPy_jpeg_top_trunc1_19();
		void eval();
