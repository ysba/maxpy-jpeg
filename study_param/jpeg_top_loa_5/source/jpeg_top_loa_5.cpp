...
#include "jpeg_top_loa_5.h"
#include "jpeg_top_loa_5__Syms.h"

//============================================================
// Constructors

jpeg_top_loa_5::jpeg_top_loa_5(VerilatedContext* _vcontextp__, const char* _vcname__)
    : VerilatedModel{*_vcontextp__}
    , vlSymsp{new jpeg_top_loa_5__Syms(contextp(), _vcname__, this)}
    , clk{vlSymsp->TOP.clk}
    , rst{vlSymsp->TOP.rst}
...
jpeg_top_loa_5::jpeg_top_loa_5(const char* _vcname__)
    : jpeg_top_loa_5(Verilated::threadContextp(), _vcname__)
{
}
...
void jpeg_top_loa_5::eval_step() {
    VL_DEBUG_IF(VL_DBG_MSGF("+++++TOP Evaluate jpeg_top_loa_5::eval_step\n"); );
#ifdef VL_DEBUG
    // Debug assertions
...
//============================================================
// Events and timing
bool jpeg_top_loa_5::eventsPending() { return false; }

uint64_t jpeg_top_loa_5::nextTimeSlot() {
...
const char* jpeg_top_loa_5::name() const {
    return vlSymsp->name();
}
...
VL_ATTR_COLD void jpeg_top_loa_5::final() {
...
const char* jpeg_top_loa_5::hierName() const { return vlSymsp->name(); }
const char* jpeg_top_loa_5::modelName() const { return "jpeg_top_loa_5"; }
unsigned jpeg_top_loa_5::threads() const { return 1; }
