...
//---------------------------------------------------------------------------------------------------------------------
// "MAxPy_Vjpeg_top_loa_18" class

#pragma GCC visibility push(hidden)
class MAxPy_jpeg_top_loa_18 : public jpeg_top_loa_18 {
	public:
		MAxPy_jpeg_top_loa_18(const char* name);
		~MAxPy_jpeg_top_loa_18();
		void eval();
