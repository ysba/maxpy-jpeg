...
//---------------------------------------------------------------------------------------------------------------------
// "MAxPy_Vjpeg_top_trunc1_10" class

#pragma GCC visibility push(hidden)
class MAxPy_jpeg_top_trunc1_10 : public jpeg_top_trunc1_10 {
	public:
		MAxPy_jpeg_top_trunc1_10(const char* name);
		~MAxPy_jpeg_top_trunc1_10();
		void eval();
