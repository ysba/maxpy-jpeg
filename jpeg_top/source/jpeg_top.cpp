...
jpeg_top::jpeg_top(VerilatedContext* _vcontextp__, const char* _vcname__)
    : VerilatedModel{*_vcontextp__}
    , vlSymsp{new jpeg_top__Syms(contextp(), _vcname__, this)}
    , clk{vlSymsp->TOP.clk}
    , rst{vlSymsp->TOP.rst}
...
jpeg_top::jpeg_top(const char* _vcname__)
    : jpeg_top(Verilated::threadContextp(), _vcname__)
{
}
...
void jpeg_top::eval_step() {
    VL_DEBUG_IF(VL_DBG_MSGF("+++++TOP Evaluate jpeg_top::eval_step\n"); );
#ifdef VL_DEBUG
    // Debug assertions
...
//============================================================
// Events and timing
bool jpeg_top::eventsPending() { return false; }

uint64_t jpeg_top::nextTimeSlot() {
...
const char* jpeg_top::name() const {
    return vlSymsp->name();
}
...
VL_ATTR_COLD void jpeg_top::final() {
...
const char* jpeg_top::hierName() const { return vlSymsp->name(); }
const char* jpeg_top::modelName() const { return "jpeg_top"; }
unsigned jpeg_top::threads() const { return 1; }
