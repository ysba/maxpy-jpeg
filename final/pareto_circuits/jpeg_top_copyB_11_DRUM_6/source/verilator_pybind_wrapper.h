...
#include "verilated.h"
#include "jpeg_top_copyB_11_DRUM_6.h"
...
//---------------------------------------------------------------------------------------------------------------------
// "MAxPy_Vjpeg_top_copyB_11_DRUM_6" class

#pragma GCC visibility push(hidden)
class MAxPy_jpeg_top_copyB_11_DRUM_6 : public jpeg_top_copyB_11_DRUM_6 {
	public:
		MAxPy_jpeg_top_copyB_11_DRUM_6(const char* name);
		~MAxPy_jpeg_top_copyB_11_DRUM_6();
		void eval();
