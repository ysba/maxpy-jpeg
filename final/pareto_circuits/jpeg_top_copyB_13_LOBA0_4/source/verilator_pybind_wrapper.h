...
//---------------------------------------------------------------------------------------------------------------------
// "MAxPy_Vjpeg_top_copyB_13_LOBA0_4" class

#pragma GCC visibility push(hidden)
class MAxPy_jpeg_top_copyB_13_LOBA0_4 : public jpeg_top_copyB_13_LOBA0_4 {
	public:
		MAxPy_jpeg_top_copyB_13_LOBA0_4(const char* name);
		~MAxPy_jpeg_top_copyB_13_LOBA0_4();
		void eval();
