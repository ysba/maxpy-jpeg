...
//---------------------------------------------------------------------------------------------------------------------
// "MAxPy_Vjpeg_top_copyB_12_DRUM_7" class

#pragma GCC visibility push(hidden)
class MAxPy_jpeg_top_copyB_12_DRUM_7 : public jpeg_top_copyB_12_DRUM_7 {
	public:
		MAxPy_jpeg_top_copyB_12_DRUM_7(const char* name);
		~MAxPy_jpeg_top_copyB_12_DRUM_7();
		void eval();
