...
//---------------------------------------------------------------------------------------------------------------------
// "MAxPy_Vjpeg_top_copyB_12_DRUM_8" class

#pragma GCC visibility push(hidden)
class MAxPy_jpeg_top_copyB_12_DRUM_8 : public jpeg_top_copyB_12_DRUM_8 {
	public:
		MAxPy_jpeg_top_copyB_12_DRUM_8(const char* name);
		~MAxPy_jpeg_top_copyB_12_DRUM_8();
		void eval();
