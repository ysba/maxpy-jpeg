...
#ifndef VERILATED_JPEG_TOP_TRUNC0_12_DRUM_8_H_
#define VERILATED_JPEG_TOP_TRUNC0_12_DRUM_8_H_  // guard
...
class jpeg_top_trunc0_12_DRUM_8 VL_NOT_FINAL : public VerilatedModel {
  private:
  ...
  public:
    ...
    explicit jpeg_top_trunc0_12_DRUM_8(VerilatedContext* contextp, const char* name = "TOP");
    explicit jpeg_top_trunc0_12_DRUM_8(const char* name = "TOP");
    /// Destroy the model; called (often implicitly) by application code
    virtual ~jpeg_top_trunc0_12_DRUM_8();
  private:
    VL_UNCOPYABLE(jpeg_top_trunc0_12_DRUM_8);  ///< Copying not allowed
