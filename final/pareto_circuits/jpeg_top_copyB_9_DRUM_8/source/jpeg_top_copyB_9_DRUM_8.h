...
#ifndef VERILATED_JPEG_TOP_COPYB_9_DRUM_8_H_
#define VERILATED_JPEG_TOP_COPYB_9_DRUM_8_H_  // guard

#include "verilated.h"

class jpeg_top_copyB_9_DRUM_8__Syms;
class sub___024root;
class sub_dct;
class sub_quantizer;
...
class jpeg_top_copyB_9_DRUM_8 VL_NOT_FINAL : public VerilatedModel {
  private:
    // Symbol table holding complete model state (owned by this class)
    jpeg_top_copyB_9_DRUM_8__Syms* const vlSymsp;
  ...
  public:
    ...
    explicit jpeg_top_copyB_9_DRUM_8(VerilatedContext* contextp, const char* name = "TOP");
    explicit jpeg_top_copyB_9_DRUM_8(const char* name = "TOP");
    /// Destroy the model; called (often implicitly) by application code
    virtual ~jpeg_top_copyB_9_DRUM_8();
  private:
    VL_UNCOPYABLE(jpeg_top_copyB_9_DRUM_8);  ///< Copying not allowed
