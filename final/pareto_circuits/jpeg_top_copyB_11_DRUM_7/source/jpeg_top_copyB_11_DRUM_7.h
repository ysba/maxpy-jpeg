...
#ifndef VERILATED_JPEG_TOP_COPYB_11_DRUM_7_H_
#define VERILATED_JPEG_TOP_COPYB_11_DRUM_7_H_  // guard
...
class jpeg_top_copyB_11_DRUM_7 VL_NOT_FINAL : public VerilatedModel {
  private:
  ...
  public:
    ...
    explicit jpeg_top_copyB_11_DRUM_7(VerilatedContext* contextp, const char* name = "TOP");
    explicit jpeg_top_copyB_11_DRUM_7(const char* name = "TOP");
    /// Destroy the model; called (often implicitly) by application code
    virtual ~jpeg_top_copyB_11_DRUM_7();
  private:
    VL_UNCOPYABLE(jpeg_top_copyB_11_DRUM_7);  ///< Copying not allowed
