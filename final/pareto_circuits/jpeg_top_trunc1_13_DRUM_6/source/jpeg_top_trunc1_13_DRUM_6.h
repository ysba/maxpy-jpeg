...
#ifndef VERILATED_JPEG_TOP_TRUNC1_13_DRUM_6_H_
#define VERILATED_JPEG_TOP_TRUNC1_13_DRUM_6_H_  // guard
...
class jpeg_top_trunc1_13_DRUM_6 VL_NOT_FINAL : public VerilatedModel {
  private:
  ...
  public:
    ...
    explicit jpeg_top_trunc1_13_DRUM_6(VerilatedContext* contextp, const char* name = "TOP");
    explicit jpeg_top_trunc1_13_DRUM_6(const char* name = "TOP");
    /// Destroy the model; called (often implicitly) by application code
    virtual ~jpeg_top_trunc1_13_DRUM_6();
  private:
    VL_UNCOPYABLE(jpeg_top_trunc1_13_DRUM_6);  ///< Copying not allowed
