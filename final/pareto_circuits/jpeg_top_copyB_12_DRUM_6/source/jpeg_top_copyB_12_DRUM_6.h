...
#ifndef VERILATED_JPEG_TOP_COPYB_12_DRUM_6_H_
#define VERILATED_JPEG_TOP_COPYB_12_DRUM_6_H_  // guard

#include "verilated.h"

class jpeg_top_copyB_12_DRUM_6__Syms;
class sub___024root;
class sub_dct;
class sub_quantizer;
...
class jpeg_top_copyB_12_DRUM_6 VL_NOT_FINAL : public VerilatedModel {
  private:
    // Symbol table holding complete model state (owned by this class)
    jpeg_top_copyB_12_DRUM_6__Syms* const vlSymsp;
  ...
  public:
    ...
    explicit jpeg_top_copyB_12_DRUM_6(VerilatedContext* contextp, const char* name = "TOP");
    explicit jpeg_top_copyB_12_DRUM_6(const char* name = "TOP");
    /// Destroy the model; called (often implicitly) by application code
    virtual ~jpeg_top_copyB_12_DRUM_6();
  private:
    VL_UNCOPYABLE(jpeg_top_copyB_12_DRUM_6);  ///< Copying not allowed
