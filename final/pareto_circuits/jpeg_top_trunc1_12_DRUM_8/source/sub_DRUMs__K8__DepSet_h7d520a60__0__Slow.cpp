...
VL_ATTR_COLD void sub_DRUMs__K8___eval_initial__TOP__jpeg_top__DOT__u19__DOT__u14__DOT__u11__DOT__u9__u11(sub_DRUMs__K8* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    jpeg_top_trunc1_12_DRUM_8__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+                sub_DRUMs__K8___eval_initial__TOP__jpeg_top__DOT__u19__DOT__u14__DOT__u11__DOT__u9__u11\n"); );
    // Body
...
VL_ATTR_COLD void sub_DRUMs__K8___ctor_var_reset(sub_DRUMs__K8* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    jpeg_top_trunc1_12_DRUM_8__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+                sub_DRUMs__K8___ctor_var_reset\n"); );
    // Body
    ...
    vlSelf->__PVT__U1__DOT__m = VL_RAND_RESET_I(6);
    vlSelf->__PVT__U1__DOT__n = VL_RAND_RESET_I(6);
