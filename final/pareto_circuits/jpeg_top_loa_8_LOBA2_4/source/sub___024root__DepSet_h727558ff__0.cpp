...
#endif
                VL_FATAL_MT("results_b/jpeg_top_loa_8_LOBA2_4/rtl/jpeg_top.v", 50, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("results_b/jpeg_top_loa_8_LOBA2_4/rtl/jpeg_top.v", 50, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("results_b/jpeg_top_loa_8_LOBA2_4/rtl/jpeg_top.v", 50, "", "NBA region did not converge.");
            }
