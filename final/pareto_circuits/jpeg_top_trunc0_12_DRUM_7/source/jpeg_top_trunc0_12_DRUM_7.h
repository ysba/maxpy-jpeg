...
#ifndef VERILATED_JPEG_TOP_TRUNC0_12_DRUM_7_H_
#define VERILATED_JPEG_TOP_TRUNC0_12_DRUM_7_H_  // guard

#include "verilated.h"

class jpeg_top_trunc0_12_DRUM_7__Syms;
class sub___024root;
class sub_dct;
class sub_quantizer;
...
class jpeg_top_trunc0_12_DRUM_7 VL_NOT_FINAL : public VerilatedModel {
  private:
    // Symbol table holding complete model state (owned by this class)
    jpeg_top_trunc0_12_DRUM_7__Syms* const vlSymsp;
  ...
  public:
    ...
    explicit jpeg_top_trunc0_12_DRUM_7(VerilatedContext* contextp, const char* name = "TOP");
    explicit jpeg_top_trunc0_12_DRUM_7(const char* name = "TOP");
    /// Destroy the model; called (often implicitly) by application code
    virtual ~jpeg_top_trunc0_12_DRUM_7();
  private:
    VL_UNCOPYABLE(jpeg_top_trunc0_12_DRUM_7);  ///< Copying not allowed
