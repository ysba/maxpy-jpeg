...
VL_ATTR_COLD void sub_DRUMs__K7___eval_initial__TOP__jpeg_top__DOT__u19__DOT__u14__DOT__u11__DOT__u9__u11(sub_DRUMs__K7* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    jpeg_top_trunc0_12_DRUM_7__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+                sub_DRUMs__K7___eval_initial__TOP__jpeg_top__DOT__u19__DOT__u14__DOT__u11__DOT__u9__u11\n"); );
    // Body
...
VL_ATTR_COLD void sub_DRUMs__K7___ctor_var_reset(sub_DRUMs__K7* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    jpeg_top_trunc0_12_DRUM_7__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+                sub_DRUMs__K7___ctor_var_reset\n"); );
    // Body
    ...
    vlSelf->__PVT__U1__DOT__m = VL_RAND_RESET_I(5);
    vlSelf->__PVT__U1__DOT__n = VL_RAND_RESET_I(5);
